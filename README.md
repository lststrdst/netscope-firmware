...
Текущий интерфейс с **демонстрационными данными** — без домашней истории трафика,
реальных адресов и секретов. [Галерея и способ воспроизведения](docs/SCREENSHOTS.md).

**NETSCOPE — устройства, соединения и инспектор**

![NETSCOPE — соединения, демонстрационные данные](docs/screenshots/netscope-traffic-demo.jpg)

**VPN Quick Setup — домашний доступ, VPN и голосовой канал**

![NETSCOPE — быстрая настройка VPN, демонстрационные данные](docs/screenshots/vpn-quick-setup-demo.jpg)

[Что уже сделано и что осталось](docs/ROADMAP.md).
...
Группа серверов из подписки, ручной выбор и автоматический UDP-резерв:
[HY2 Channels](docs/HY2-CHANNELS.md).
